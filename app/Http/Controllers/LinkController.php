...
class LinkController extends Controller{
    ...
    public function edit(Link $link): View
		{
		    // --- CONTOH MANUAL QUERY ---
		    // $link = Link::findOrFail($link->id); // atau menggunakan $id dari parameter route
		    // -----------------------------------------------------
    ...
    {
    // --- CONTOH MANUAL QUERY ---
    // Jika tidak pakai binding di parameter, biasanya parameter jadi ($request, $id)
    ...
    public function destroy(Link $link): RedirectResponse
		{
		    // --- CONTOH MANUAL QUERY ---
		    // Jika tidak pakai binding di parameter, biasanya parameter jadi ($id)
		    // $link = Link::findOrFail($id); 
		    // -----------------------------------------------------
