...
@section('title', 'Tambah Menu / Link - Kedai Senja')
            ...
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    ...
                    <p class="text-xs sm:text-sm font-bold text-[#8b6a50] mt-1">
                        Tambahkan menu atau informasi untuk halaman Kedai Senja
                    </p>
    ...
    <div
        ...
        <div>
            ...
            <p class="font-black text-sm text-[#3f2a1d]">
                Tambahkan Link Kedai
            </p>

            <p class="text-xs font-semibold text-[#7a5940] mt-1 leading-relaxed">
                Link yang aktif akan otomatis ditampilkan pada halaman publik Kedai Senja.
            </p>
        ...
        <form
            ...
            <div class="space-y-2">
                ...
                <p class="text-[11px] font-semibold text-[#8b6a50]">
                    Contoh: link menu digital, WhatsApp, GoFood, GrabFood, Instagram, atau Google Maps.
                </p>
            ...
            <div class="space-y-3">
                ...
                <div
                    ...
                    <div
                        id="preview-empty"
                        class="flex flex-col items-center justify-center gap-3 py-10 px-6 cursor-pointer hover:bg-[#eee2d2]">
                        ...
                        <p class="text-xs font-medium text-[#8b6a50] text-center">
            ...
            <div class="pt-2">
                ...
                <label
                    ...
                    <div
                        class="flex items-center justify-between gap-4 bg-[#f5efe6] border-2 border-[#3f2a1d] rounded-2xl p-4 shadow-[3px_3px_0px_0px_#3f2a1d]">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <span
                                    id="is_active_hint"
                                    class="text-[11px] font-semibold text-[#8b6a50]">
                        ...
                        <span
                            class="relative w-12 h-7 bg-slate-300 peer-checked:bg-emerald-400 rounded-full border-2 border-[#3f2a1d] transition-colors shrink-0 after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:w-5 after:h-5 after:bg-white after:rounded-full after:border-2 after:border-[#3f2a1d] transition-transform peer-checked:after:translate-x-5">
                        </span>
            ...
            <div
                class="pt-6 border-t-2 border-dashed border-[#d7c3ad] flex flex-col-reverse sm:flex-row justify-end gap-3">
